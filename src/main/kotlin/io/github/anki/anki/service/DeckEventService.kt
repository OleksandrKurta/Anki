...
class DeckEventService(
    ...
    @PostConstruct
    fun subscribeToDeckLogEvents() {
        val dispatcher: Dispatcher = natsClient.createDispatcher(DeckLogMessageHandler())
        dispatcher.subscribe(NatsSubject.DECK_EVENT_SUBJECT)
    }

    inner class DeckLogMessageHandler : MessageHandler {
        override fun onMessage(msg: Message) {
            ...
            deckEventRepository.insert(mongoDeckEvent).block()
        }
    }
